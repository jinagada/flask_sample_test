...
class Sqlite3:
    ...
    def __init__(self):
        ...
        Class 생성 및 변수선언
        """
        self.logger = logging.getLogger('flask_sample_test.datasources.Sqlite3')
        self.db_conn = None
    ...
    def _get_conn(self):
        ...
        try:
            ...
            err_log(self.logger, e, 'Sqlite3._get_conn', traceback.format_exc())
            self.db_conn = None
    ...
    def _close_conn(self):
        ...
        try:
            ...
            err_log(self.logger, e, 'Sqlite3._close_conn', traceback.format_exc())
            self.db_conn = None
    ...
    def execute(self, query, params=None, is_one=False):
        ...
        try:
            ...
            err_log(self.logger, e, 'Sqlite3.execute', traceback.format_exc())
            result = None
        finally:
            self._close_conn()
        return result
